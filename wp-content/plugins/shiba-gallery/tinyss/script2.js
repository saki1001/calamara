...
//		alert(this.a[s].p.style.padding);
...
TINY.scroll=function(){
	return{
		init:function(e,d,s){
			e=typeof e=='object'?e:shiba$(e); var p=e.style.left||TINY.style.val(e,'left'); e.style.left=p;
...
TINY.height=function(){
	return{
		set:function(e,h,s,d){
			e=typeof e=='object'?e:shiba$(e); var oh=e.offsetHeight, ho=e.style.height||TINY.style.val(e,'height');
...
TINY.alpha=function(){
	return{
		set:function(e,a,s){
			e=typeof e=='object'?e:shiba$(e); var o=e.style.opacity||TINY.style.val(e,'opacity'),
...
TINY.style=function(){return{val:function(e,p){e=typeof e=='object'?e:shiba$(e); return e.currentStyle?e.currentStyle[p]:document.defaultView.getComputedStyle(e,null).getPropertyValue(p)}}}();
