		...
		init = function () {
			...
			jQuery(".picture-slides-container").each(function () {
				var elm = jQuery(this),
					...
					// Element references
					settings = jQuery.extend({}, jQuery.PictureSlides.defaults, slideshows[counter++]),
//					settings = slideshows[counter++],
					...
					thumbnailLinks,
					dimBackgroundOverlay = jQuery("#" + settings.containerId + " ." + settings.dimBackgroundOverlayClass),
